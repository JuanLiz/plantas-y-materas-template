    ...
    render(){
        ...
        if (this.state.status==='success'){
          ...
          return (
              ...
              <Navigate to='/medellin/customers'/>
          )
        }
        ...
        return(
            ...
            <form action="update-customers" method="POST" className=" container needs-validation" onSubmit={this.update_customer} novalidate autocomplete="off">                                     
                  ...
                  <div className="modal-footer">
                    <NavLink to="/medellin/customers" type="button" className=" mx-1 align-items-center btn btn-outline-secondary inactive" role="button">
